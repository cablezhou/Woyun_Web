...
const members = ref<Member[]>([
  {
    ...
    joinDate: '2021年',
    lifePhoto: '/imagines/members/show/zhou.jpg',
    bikePhoto: '/imagines/members/bike/zhou.jpg',
    bikeBrand: 'Merida',
  ...
  },
  {
    ...
    joinDate: '2022年',
    lifePhoto: '/imagines/members/show/guo.jpg',
    bikePhoto: '/imagines/members/bike/guo.jpg',
    bikeBrand: '自组',
    bikeModel: '逗比',
    bikeFrame: '纸糊的',
    bikeGears: 'Shimano Ultegra 22速',
